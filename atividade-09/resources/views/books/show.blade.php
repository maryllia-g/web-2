        ...
        <div class="card-body">
            ...
            @if($emprestimoAberto)
                <div class="alert alert-warning">
                    <strong>Este livro está emprestado no momento.</strong><br>
                    Ele só poderá ser emprestado novamente após a devolução.
                </div>
            @else
                
                <!-- Formulário só aparece se estiver disponível -->
